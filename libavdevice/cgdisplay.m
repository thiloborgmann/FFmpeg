...
/**
 * @file
 * CoreGraphics display capture device
...
static const AVClass cgd_class = {
    .class_name = "CoreGraphics display capture device",
...
AVInputFormat ff_cgdisplay_demuxer = {
    .name           = "cgdisplay",
    .long_name      = NULL_IF_CONFIG_SMALL("CoreGraphics display capture device"),
    .priv_data_size = sizeof(CGDContext),
    .read_header    = cgd_read_header,
    .read_packet    = cgd_read_packet,
    .read_close     = cgd_close,
    .flags          = AVFMT_NOFILE,
    .priv_class     = &cgd_class,
};
