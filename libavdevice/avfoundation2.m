...
#define FAIL {            \
    ...
    if (s->strict_std_compliance > FF_COMPLIANCE_EXPERIMENTAL) {
        av_log(s, AV_LOG_ERROR, "AVFoundation2 input device is experimental. Use -strict experimental to enable it.\n");
...
static const AVClass avf_class = {
    .class_name = "AVFoundation2 input device",
...
AVInputFormat ff_avfoundation2_demuxer = {
    .name           = "avfoundation2",
    .long_name      = NULL_IF_CONFIG_SMALL("AVFoundation2 input device"),
